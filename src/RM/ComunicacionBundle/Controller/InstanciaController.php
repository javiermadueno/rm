...
class InstanciaController extends Controller
{
    ...
    {
        $em = $this->getDoctrine()->getManager($_SESSION['connection']);
        $servicio  =  $this->get('segmentoservice');
        ...
        if ($id_variable > -1) {
            ...
            $tipo = $em->getRepository('RMDiscretasBundle:Tipo')->find($id_tipo_variable);
            $result = $servicio->getSegmentosFiltrados($tipo, -1,-1,-1, -1, $fecha_busqueda);
        }
