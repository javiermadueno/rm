...
class SegmentoRepository extends EntityRepository
{
	...
	public function obtenerSegmentoByIdComunicacion($id_comunicacion)
    {
		...
		if($id_comunicacion != -1){
			$dql .= " AND sc.idComunicacion IN (". $id_comunicacion. ")";
		}
     ...
     * @return array
     */
    public function findSegmentosByIdVtYFecha($id_vt = 0, \DateTime $fecha)
    {
        $dql = "
            SELECT s
            FROM RMSegmentoBundle:Segmento s
     ...
     * @return mixed
     */
	public function obtenerSegmentosByIdVid($id_vid){
     ...
     * @return array
     */
    public function findSegmentosByIdVidYFecha($id_vid = 0, \Datetime $fecha)
    {
        $dql = "
            SELECT s
            FROM RMSegmentoBundle:Segmento s
     ...
     * @return mixed
     */
	public function obtenerSegmentosByIdVil($id_vil)
    {
     ...
     * @return array
     */
    public function findSegmentosByIdVilYFecha($id_vil = 0, \DateTime $fecha)
    {
        $dql = "
            SELECT s
            FROM RMSegmentoBundle:Segmento s
